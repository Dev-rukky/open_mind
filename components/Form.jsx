  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        <label >
          <span className="font-outfit font-semibold text-base text-gray-700">Your AI prompt</span>
          <textarea
            value={post.prompt}
        ...
        <label >
          <span className="font-outfit font-semibold text-base text-gray-700">Tag {" "} <span className="font-normal">(#product, #webdevelopment, #idea)</span></span>
          <input
            value={post.tag}
