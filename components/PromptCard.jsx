  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between gap-5 items-start">
        <div className="flex-1 flex justify-startitems-ceter gap-3 cursor-pointer">
          <Image src={post.creator.image} alt='user_image' width={40} height={40 } className="rounded-full object-contain"/>
          <div className="flex flex-col">
              <h2 className="font-outfit font-semibold text-gray-900">{post.creator.username}</h2>
      ...
      <p className="my-4 font-outfit text-sm text-gray-700">
        {post.prompt}
      </p>
